import dictionary from '../C-64-offlineDictionary-Database-master';
var word=dictionary[pink]['LexicalCategory']
var LexicalCategory=dictionary[pink2]['lexiconCategory']
var definition=dictionary[pink3]['definition']  
this.setState({
  "word":word,
